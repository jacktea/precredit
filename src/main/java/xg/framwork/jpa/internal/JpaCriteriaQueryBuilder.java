...
import xg.framework.domain.Query;
...
public class JpaCriteriaQueryBuilder {
    ...
    public final <T extends Entity> CriteriaQuery<T> createCriteriaQuery(
            Query<T> dddQuery, EntityManager entityManager) {
    ...
    public final <T extends Entity> CriteriaQuery<Long> createCountCriteriaQuery(
    		QuerySettings<T> settings, EntityManager entityManager) {
        CriteriaBuilder builder = entityManager.getCriteriaBuilder();
